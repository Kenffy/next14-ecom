...
import { adminCategoryStore, DeleteCategory, useAdminCategoryState } from "./admin-categories-store";
...
export const columns: ColumnDef<CategoryModel>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const { isLoading, handleAction } = useDropdownAction({ category });
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={async () => await handleAction("delete")}>
              Delete Category
            </DropdownMenuItem>
            <DropdownMenuSeparator />
          </DropdownMenuContent>
...
const useDropdownAction = (props: { category: CategoryModel }) => {
  ...
  const handleAction = async (action: DropdownAction) => {
    ...
    switch (action) {
      case "edit":
        adminCategoryStore.updateCategory(category);
        break;
      case "delete":
...
export function CategoriesTable() {
  const { categories } = useAdminCategoryState();
  ...
  const table = useReactTable({
    data: categories as Array<CategoryModel>,
    columns,
